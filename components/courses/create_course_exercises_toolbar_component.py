...
class CreateCourseExercisesToolbarComponent(BaseComponent):
    def __init__(self, page: Page):
        ...
        self.create_exercise_title = Text(page, "create-course-exercises-box-toolbar-title-text", "Exercises")
    ...
    @allure.step('Checking visible "Create course exercise toolbar"')
